...
// ⚠️ นี่คือการ "ซ่อนเมนู" ไม่ใช่การควบคุมสิทธิ์ · สิทธิ์จริงพิสูจน์ที่ verify-rls.mjs
{
  ...
  // คำว่า "รออนุมัติ" ไปโผล่ที่การ์ดสรุปบนหน้าภาพรวมด้วย (ซึ่งหัวหน้าโครงการ
  ...
  check('P0-UI-04b หัวหน้าโครงการไม่มีลิงก์สองเมนูนั้น แต่มีลิงก์ "คนเข้าโครงการ" บนหน้าเดียวกัน',
    hidden && landmark,
