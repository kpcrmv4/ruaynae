...
/**
 * รายชื่อคนที่ยังไม่เข้าไซต์ แบบ **การ์ดสี่เหลี่ยมเล็ก** สำหรับเลือกด้วยนิ้วเดียว
 *
 * ทำไมไม่ใช้แถวยาวเหมือนมุมมองรายชื่อ: หน้านี้ถูกใช้ยืนกลางไซต์ ถือมือถือมือเดียว
...
export type PickItem = {
  ...
  /** ลงชื่อเต็มวันที่ไซต์อื่นไปแล้ว = กดยังไงก็ไม่ผ่าน */
  full: boolean
  /** เหลือโควตาแค่ครึ่งวัน — เลือกครึ่งวันให้เองแล้ว ไม่ต้องมีชิปให้กด */
  halfOnly: boolean
  /** ไซต์ที่เขาอยู่วันนี้ (ถ้ามี) */
  where: string | null
  picked: boolean
  half: boolean
